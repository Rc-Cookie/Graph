...
public interface Tree<N,E> extends Forest<N,E> {

    Tree<Object,Object> EMPTY = new Tree<>() {
        @Override
        ...
        @Override
        public @NotNull Tree<Object, Object> clone() {
            return this;
        }

        @Override
        public @NotNull Tree<Object, Object> newInstance() {
            return this;
        }
    ...
    @Override
    @NotNull Tree<N,E> clone();

    @Override
    @NotNull Tree<N,E> newInstance();


    @SuppressWarnings("unchecked")
    static <N,E> Tree<N,E> empty() {
        return (Tree<N,E>) EMPTY;
    }
}
